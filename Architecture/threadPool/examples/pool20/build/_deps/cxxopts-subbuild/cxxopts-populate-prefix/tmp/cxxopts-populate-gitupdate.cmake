...
if("${show_ref_output}" MATCHES "refs/remotes/v2.2.1")
  string(REGEX MATCH "^([^/]+)/(.+)$" _unused "v2.2.1")
...
# yet).
execute_process(
  COMMAND "/usr/bin/git" rev-list --max-count=1 v2.2.1
  WORKING_DIRECTORY "/home/hungtran/Workspace/cpp/designPattern/Architecture/threadPool/examples/pool20/build/_deps/cxxopts-src"
  RESULT_VARIABLE error_code
...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(is_remote_ref)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/hungtran/Workspace/cpp/designPattern/Architecture/threadPool/examples/pool20/build/_deps/cxxopts-src/'.\nYou will have to resolve the conflicts manually")
    endif()
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: '/home/hungtran/Workspace/cpp/designPattern/Architecture/threadPool/examples/pool20/build/_deps/cxxopts-src/'.\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
  else()
